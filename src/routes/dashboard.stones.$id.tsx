  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      setValues({
        ...
        source_type: ((data as any).source_type ?? "standard") as "standard" | "direct_vault",
        private_drop_enabled: !!(data as any).private_until && new Date((data as any).private_until).getTime() > Date.now(),
        private_drop_duration_hours: "24",
        private_until: (data as any).private_until ?? "",
